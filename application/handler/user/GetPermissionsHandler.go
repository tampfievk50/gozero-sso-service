...
func GetPermissionsHandler(svcCtx servicecontext.ServiceContextInterface) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		resp, err := svcCtx.(*svc.ServiceContext).Svc.UserService.GetUserPermissions(r.Context(), req.Id)
		if err != nil {

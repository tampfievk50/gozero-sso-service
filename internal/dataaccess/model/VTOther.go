...
type VTOther struct {
	...
	SubmitDate    string  `json:"submit_date" gorm:"submit_date"` // computed, not in DB
	DoneDate      string  `json:"done_date" gorm:"done_date"`     // computed, not in DB
